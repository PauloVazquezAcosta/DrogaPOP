...
public class Main {
    ...
    private static void menuOpciones(int opcion, Scanner entrada) {
        switch (opcion) {
            ...
            case 2:
                System.out.println("-----------------------------------------------------------------------------------------------------");
                System.out.println("\nINTRODUCIR EMPLEADO ... ");
                Employee employee = introducirEmpleado(entrada);
                System.out.println("-----------------------------------------------------------------------------------------------------");
                break;
            case 3:
                System.out.println("-----------------------------------------------------------------------------------------------------");
     ...
     * @return employee
     */
    public static Employee introducirEmpleado(Scanner entrada){
        ...
        Employee employee = new Employee(dni, nome, apelidos, postoTraballo, contratoDende, salario, deptno);
